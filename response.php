                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if ($response['state'] !== 'COMPLETED'): ?>
                            <span class='my-2 text-light bg-danger d-flex justify-content-center'> Payment Incomplete, <a
                                    href="<?= $again_url ?>" class='text-warning fw-bold mx-2'> click here </a> to the
                                proceed again payment.. </span>
                        <?php endif; ?>
                        <div class='row'>
                            <div class="mb-3 col-md-6">
                                <label for="order_id" class="form-label">Order Status <span
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="order_id" class="form-label">Order_PhonePe Id <span
                                        class='text-danger'>*</span></label>
                                <input type="text" class="form-control" value="<?= $response['orderId'] ?? '' ?>"
                                    readonly>
                            </div>

                            <div class="mb-3 col-md-6">
                                <label for="order_amount" class="form-label">Order Amount <span
                                        class='text-danger'>*</span></label>
                                <input type="text" class="form-control"
                                    value="<?= ($response['amount'] / 100 ?? 0) . " INR" ?>" readonly>
                            </div>
